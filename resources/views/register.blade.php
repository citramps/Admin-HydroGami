    ...
    <div class="flex justify-center items-center h-screen">
        ...
        <form action="{{ route('register') }}" method="POST" class="mt-4">
            ...
            <div class="mb-4 text-left">
                ...
                <input type="text" id="name" name="name" class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Masukkan Nama Anda" required>
            </div>
            <div class="mb-4 text-left">
                <label for="email" class="block text-sm text-gray-800">Email</label>
                <input type="email" id="email" name="email" class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Masukkan Email" required>
            </div>
            <div class="mb-4 text-left">
                <label for="password" class="block text-sm text-gray-800">Kata Sandi</label>
                <input type="password" id="password" name="password" class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Masukkan Kata Sandi" required>
            </div>
