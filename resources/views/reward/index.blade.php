    ...
    <div class="flex min-h-screen">
        ...
        <div class="sidebar w-64 bg-custom-green text-white p-4 z-30 flex flex-col">
            ...
            <nav class="space-y-2 flex-1">
                ...
                <a href="{{ route('reward.index') }}" class="flex items-center py-3 px-3 bg-white text-green-500 rounded-lg shadow group">
                    <svg class="w-5 h-5 mr-3 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 576 512">
                        <path
