...
<body> 
    ...
    <a href="{{ route('dashboard') }}" class="flex items-center py-2 px-4 hover:bg-green-300 rounded">
        ...
        <a href="{{ route('misi.index') }}" class="flex items-center py-2 px-4 bg-white text-green-300 rounded shadow">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="mission_number" id="mission_number" placeholder="Masukkan Nomor Misi Gamifikasi" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
    </div>
    <div class="mb-4">
        <label class="block text-gray-700 font-medium mb-2" for="mission_name">Nama Misi</label>
        <input type="text" name="mission_name" id="mission_name" placeholder="Masukkan Nama Misi Gamifikasi" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
    </div>
    <div class="mb-4">
        <label class="block text-gray-700 font-medium mb-2" for="mission_description">Deskripsi Misi</label>
        <textarea name="mission_description" id="mission_description" placeholder="Masukkan Deskripsi Misi Gamifikasi" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500"></textarea>
    </div>
    <div class="mb-4">
        <label class="block text-gray-700 font-medium mb-2" for="mission_stage">Tahap Misi</label>
        <input type="text" name="mission_stage" id="mission_stage" placeholder="Masukkan Tahap Misi Gamifikasi" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
    </div>
    <div class="mb-4">
        <label class="block text-gray-700 font-medium mb-2" for="mission_points">Jumlah Poin Gamifikasi</label>
        <input type="number" name="mission_points" id="mission_points" placeholder="Masukkan Poin Misi Gamifikasi" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
    </div>
