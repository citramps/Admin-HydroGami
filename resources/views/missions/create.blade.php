            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('misi.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="mission_number" id="mission_number"
                            placeholder="Masukkan Nomor Misi Gamifikasi"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="mission_name" id="mission_name"
                            placeholder="Masukkan Nama Misi Gamifikasi"
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea name="mission_description" id="mission_description"
                            ...
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500"></textarea>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2" for="mission_stage">Tahap Misi</label>
                        <input type="text" name="mission_stage" id="mission_stage"
                            placeholder="Masukkan Tahap Misi Gamifikasi"
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-medium mb-2" for="mission_points">Jumlah Poin Gamifikasi</label>
                        <input type="number" name="mission_points" id="mission_points"
                            placeholder="Masukkan Poin Misi Gamifikasi"
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500">
                    </div>
                    <div class="text-center">
                        <button type="submit"
                            class="px-4 py-2 bg-custom-green text-white font-semibold rounded-md hover:bg-green-600">+ Tambah Misi</button>
                    </div>
                </form>
            </div>
        </div>
