            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="{{ route('misi.update', $mission->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="mission_id" name="mission_id"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="tahap_misi" name="tahap_misi"
                            class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-green-500"
                            value="{{ $mission->tahap_misi }}">
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit"
                            class="px-4 py-2 bg-custom-green text-white font-semibold rounded-md hover:bg-green-600">Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
